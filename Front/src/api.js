...
export async function apiUpdateUser(id, data, token) {
    return request(`/api/users/edit/${id}`, {
        method: 'PUT',
        body: data,
        token,
    });
...
export async function apiListUsers(params = {}, token) {
    ...
    const qs = query.toString();
    return request(`/api/users/all${qs ? `?${qs}` : ''}`, {
        token,
    });
}
...
export async function apiListTeacherCourses(params = {}, token) {
    ...
    const qs = query.toString();
    return request(`/api/teacher-courses/all${qs ? `?${qs}` : ''}`, {
        token,
    });
}

export async function apiCreateTeacherCourse(data, token) {
    return request('/api/teacher-courses/create', {
        method: 'POST',
        body: data,
        token,
    });
...
export async function apiListEventCourses(params = {}, token) {
    ...
    const qs = query.toString();
    return request(`/api/event-courses/all${qs ? `?${qs}` : ''}`, {
        token,
    });
}

export async function apiCreateEventCourse(data, token) {
    return request('/api/event-courses/create', {
        method: 'POST',
        body: data,
        token,
    });
...
export async function apiListAvailabilities(params = {}, token) {
    ...
    const qs = query.toString();
    return request(`/api/availabilities/all${qs ? `?${qs}` : ''}`, {
        token,
    });
}
...
export async function apiListMessages(params = {}, token) {
    ...
    const qs = query.toString();
    return request(`/api/messages/all${qs ? `?${qs}` : ''}`, {
        token,
    });
}
...
export async function apiListMessageUsers(params = {}, token) {
    const query = new URLSearchParams();
    if (params.sender_id) {
        query.set('sender_id', params.sender_id);
    }
    if (params.receiver_id) {
        query.set('receiver_id', params.receiver_id);
    }
    ...
    const qs = query.toString();
    return request(`/api/message-users/all${qs ? `?${qs}` : ''}`, {
        token,
    });
}
